...
from utils import is_safe_path, get_working_dir, truncate_string
...
@register_tool(
    name="read_file",
    description="Read the contents of a file in the working directory. Returns the file contents as text.",
    parameters={
        "type": "object",
        "properties": {
            "path": {
...
def read_file(path: str) -> str:
    ...
    file_path = get_working_dir() / path
...
@register_tool(
    name="append_file",
    description="Append content to an existing file in the working directory.",
    parameters={
        "type": "object",
        "properties": {
            "path": {
...
@register_tool(
    name="list_directory",
    description="List files and directories in a path within the working directory.",
    parameters={
        "type": "object",
        "properties": {
            "path": {
                "type": "string",
                "description": "Relative path to list (use '.' for current directory)",
                "default": "."
            }
        },
        "required": []
